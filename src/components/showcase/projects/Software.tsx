    ...
    return (
        <div className="site-page-content">
            ...
            <div className="text-block">
                <h2>maxshishkin.com</h2>
                <br />
                <p>
                    maxshishkin.com is my portfolio website, and also the
                ...
                <p>
                    ...
                    <a
                        rel="noreferrer"
                        target="_blank"
                        href="https://maxshishkin.vercel.app/"
                    >
                        here
                    </a>{' '}
                ...
                <ul>
                    <li>
                        <a
                            rel="noreferrer"
                            target="_blank"
                            href="https://maxshishkin.com"
                        >
                            <p>
                                <b>[3D Site]</b> - maxshishkin.com
                            </p>
                        </a>
                    </li>
                    <li>
                        ...
                        >
                            <p>
                                <b>[OS Site]</b> - maxshishkin.vercel.app
                            </p>
                        </a>
                    </li>
                    <li>
                        <a
                            rel="noreferrer"
                            target="_blank"
                            href="https://github.com/maxshishkin/portfolio-website"
                        >
                            <p>
                    ...
                    <li>
                        <a
                            rel="noreferrer"
                            target="_blank"
                            href="https://github.com/maxshishkin/portfolio-inner-site"
                        >
                            <p>
                ...
                <p>
                    ...
                    <a
                        rel="noreferrer"
                        target="_blank"
                        href="https://twitter.com/maxshishkin"
                    >
                        @maxshishkin
                    </a>
                </p>
                ...
                <ul>
                    ...
                    <li>
                        <a
                            rel="noreferrer"
                            target="_blank"
                            href="https://github.com/maxshishkin/gsts_assets"
                        >
                            <p>
                                <b>[GitHub]</b> - Guntattchment Saga The Sequel
                                Assets Repository
                ...
                <ul>
                    <li>
                        <a
                            rel="noreferrer"
                            target="_blank"
                            href="https://github.com/maxshishkin/skip-the-scroll"
                        >
                            <p>
